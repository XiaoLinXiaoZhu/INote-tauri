!((e, t) => {
      ...
      'function' == typeof Object.getOwnPropertySymbols &&
        (i = i.concat(
          Object.getOwnPropertySymbols(o).filter(
            e => Object.getOwnPropertyDescriptor(o, e).enumerable,
          ),
        )),
        i.forEach(n => {
          t(e, n, o[n]);
  ...
  function l(e, t) {
    return (l = Object.setPrototypeOf || ((e, t) => ((e.__proto__ = t), e)))(
      e,
      t,
    );
  }
  ...
  function w(e) {
    return 'string' == typeof e ? e.replace(/[&<>"'/]/g, e => x[e]) : e;
  }
  var S =
    ...
    O = {
      ...
      handle: function (e, t, n, o, i) {
        return (
          e.forEach(e => {
            this.processors[e] && (t = this.processors[e].process(t, n, o, i));
          }),
          t
        );
      },
                        ...
                        f.forEach(n => {
                          if (!this.isValidLookup(t)) {
                            ...
                            if (
                              ...
                              this.i18nFormat.addLookupKeys(f, l, n, e, s);
                            else
                              p &&
                                (r = this.pluralResolver.getSuffix(n, s.count)),
                                p && g && f.push(c + r),
                                g &&
                                  f.push(
                                    (c += ''
                            ...
                            for (; (u = f.pop()); )
                              this.isValidLookup(t) ||
                                ((o = u), (t = this.getResource(n, e, u, s)));
                          }
                        }));
                    });
                  }
          ...
          },
          {
            ...
            value: function (e) {
              ...
              return e
                ? (e.forEach(e => {
                    if (!t) {
                      var o = this.formatLanguageCode(e);
                  ...
                  !t &&
                    ...
                    e.forEach(e => {
                      if (!t) {
                        var o = this.getLanguagePartFromCode(e);
    ...
    V = (() => {
      function e() {
        ...
        o(this, e),
          ...
          (this.options = t),
          (this.format =
            (t.interpolation && t.interpolation.format) || (e => e)),
          this.init(t);
      }
      return (
        r(e, [
            ...
            value: function (e, t, n, o) {
              ...
              var c = e => {
                if (e.indexOf(this.formatSeparator) < 0) {
                  var i = b(t, u, e);
                  return this.alwaysFormat ? this.format(i, void 0, n) : i;
                }
                var r = e.split(this.formatSeparator),
                  a = r.shift().trim(),
                  l = r.join(this.formatSeparator).trim();
                return this.format(b(t, u, a), l, n, o);
              };
              this.resetRegExp();
              var p =
              ...
              return (
                [
                  ...
                  },
                  {
                    regex: this.regexp,
                    safeValue: e =>
                      this.escapeValue ? l(this.escape(e)) : l(e),
                  },
                ].forEach(t => {
            ...
            value: function (e, t) {
              ...
              for (
                ...
                if (o[0].includes(this.formatSeparator) && !/{.*}/.test(o[1])) {
                  var p = o[1].split(this.formatSeparator).map(e => e.trim());
                  (o[1] = p.shift()), (l = p), (c = !0);
                }
                if (
      ...
      r(t, [
        ...
        },
        {
          ...
          value: function (e, t, n) {
            ...
            return e.length
              ? this.backend[n](e, t, (s, u) => {
                  s && u && i < 5
                    ? setTimeout(() => {
                        this.read.call(this, e, t, n, i + 1, 2 * r, a);
                      }, r)
                    : a(s, u);
                })
              : a(null, {});
      ...
      r(i, [
        {
          ...
          value: function () {
            ...
            var u = h(),
              l = () => {
                t.changeLanguage(t.options.lng, (e, n) => {
                  (t.isInitialized = !0),
