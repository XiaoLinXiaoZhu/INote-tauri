!(() => {
          ...
          e =
            ...
            ((t = (c, f) => (
              (t =
                ...
                ((c, f) => {
                  for (var i in f) Object.hasOwn(f, i) && (c[i] = f[i]);
                })),
              t(c, f)
            )),
            (c, f) => {
  ...
  !(() => {
    var c = i(8955),
      ...
      L = i(8135);
    MathJax.loader &&
      MathJax.loader.checkVersion('output/chtml/fonts/tex', f.q, 'chtml-font'),
      (0, c.r8)({
        _: {
          output: {
            chtml: {
